...
<body>
	...
	<div class="main"
		...
		<div class="container">
			<h1 class="logo cursive">LapTop minhtuan.com</h1>
			...
			<div class="content">
				...
				<div class="subscribe">
					<div class="row">
						<div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 " style ="padding-left: 65px;">
							<form:form class="form-inline" action="admin" method="post"
								commandName="loginForm" style="width: 250px;">
