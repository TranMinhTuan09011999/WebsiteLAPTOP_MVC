...
public class Revenue1Controller extends MinhTuanController {
	...
	public String byQuarter(ModelMap model, @RequestParam(defaultValue = "01/01/2018") Date min,
			@RequestParam(defaultValue = "31/12/2900") Date max) {
		//Cast đổi giá trị trước as về kiểu dữ liệu sau as
		//Cast để lấy quý, 1 năm có 4 quý, quý 1 từ tháng 1 đến tháng 3... Nếu ngày đặt là tháng 4, lấy 4/3 dùng hàm cast là bằng 2 => quý 2
